...
# description: greyEnum is a multi-threaded scanner and enumerator. It quickly finds out all TCP open ports through asynchronous stateless unicornscan then feeds its result to nmap for service fingerprinting. Finally based on the identified services and open ports, it extracts juicy information.

# note: provide ip address inside targets.txt
# download vulscan/vulscan.nse and copy inside /usr/share/nmap/scripts/
# download link: http://www.computec.ch/projekte/vulscan/download/nmap_nse_vulscan-2.0.tar.gz
